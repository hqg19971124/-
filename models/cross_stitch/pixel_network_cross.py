...
class Cross(nn.Module):
    ...
    def forward(self, x1, x2):
        # print('A_weight_same: ', torch.mean(self.A_weight_same), 'A_weight_diff: ', torch.mean(self.A_weight_diff), 'B_weight_same: ', torch.mean(self.B_weight_same), 'B_weight_diff: ', torch.mean(self.B_weight_diff))

        outx1 = x1 * self.A_weight_same
        outx2 = x2 * self.A_weight_diff
        o1 = outx1 + outx2

        outy1 = x1 * self.B_weight_diff
        outy2 = x2 * self.B_weight_same
        o2 = outy1 + outy2
